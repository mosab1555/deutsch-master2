...
const SENT_FILL=
[{id:"f1",s:"Ich ___ jeden Tag Deutsch.",o:["lerne","lernst","lernen","lernt"],c:0,why:"ich تأخذ e.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"study",start:"Ich",w:"lernen",structureType:"svo_core",subjectType:"pronoun",grammarTarget:"conjugation",sentenceStarter:"Ich",answerType:"verb",blankPosition:"after-subj"},
{id:"f2",s:"Du ___ in Berlin.",o:["wohnst","wohne","wohnt","wohnen"],c:0,why:"du تأخذ st.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"home",start:"Du",w:"wohnen",structureType:"svo_core",subjectType:"pronoun",grammarTarget:"conjugation",sentenceStarter:"Du",answerType:"verb",blankPosition:"after-subj"},
{id:"f3",s:"Er ___ gern Fußball.",o:["spielt","spiele","spielst","spielen"],c:0,why:"er يأخذ t.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"sport",start:"Er",w:"spielen",structureType:"svo_core",subjectType:"pronoun",grammarTarget:"conjugation",sentenceStarter:"Er",answerType:"verb",blankPosition:"after-subj"},
{id:"f4",s:"Wir ___ einen Film.",o:["sehen","sehe","sieht","siehst"],c:0,why:"wir تأخذ المصدر.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"home",start:"Wir",w:"sehen",structureType:"svo_core",subjectType:"pronoun",grammarTarget:"conjugation",sentenceStarter:"Wir",answerType:"verb",blankPosition:"after-subj"},
{id:"f5",s:"___ du Zeit?",o:["Hast","Haben","Hat","Habe"],c:0,why:"السؤال يبدأ بالفعل.",lvl:"A1",pos:"start",typ:"verb",ctx:"daily",start:"Hast",structureType:"fronted_opener",subjectType:"verb-first",grammarTarget:"conjugation",sentenceStarter:"Hast",answerType:"verb",blankPosition:"start"},
{id:"f6",s:"Kinder ___ im Garten.",o:["spielen","spielt","spiele","spielst"],c:0,why:"الجمع يأخذ المصدر.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"home",start:"Kinder",w:"spielen",structureType:"svo_core",subjectType:"noun-phrase",grammarTarget:"conjugation",sentenceStarter:"Kinder",answerType:"verb",blankPosition:"after-subj"},
{id:"f7",s:"Meine Mutter ___ heute zu Hause.",o:["bleibt","bleibst","bleiben","bleibe"],c:0,why:"المفرد المؤنث يأخذ t.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"family",start:"Meine",w:"bleiben",structureType:"svo_core",subjectType:"noun-phrase",grammarTarget:"conjugation",sentenceStarter:"Meine",answerType:"verb",blankPosition:"after-subj"},
{id:"f8",s:"Mein Bruder ___ in Berlin.",o:["wohnt","wohne","wohnst","wohnen"],c:0,why:"er ضمنيًا يأخذ t.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"family",start:"Mein",w:"wohnen",structureType:"svo_core",subjectType:"noun-phrase",grammarTarget:"conjugation",sentenceStarter:"Mein",answerType:"verb",blankPosition:"after-subj"},
{id:"f9",s:"Er sieht ___ Mann.",o:["den","der","dem","die"],c:0,why:"مذكر مفعول → den.",lvl:"A1",pos:"before-noun",typ:"article",ctx:"daily",start:"Er",w:"Mann",structureType:"np_internal",subjectType:"pronoun",grammarTarget:"akkusativ",sentenceStarter:"Er",answerType:"article",blankPosition:"before-noun"},
{id:"f10",s:"Das ist ___ Bruder.",o:["mein","meine","meinen","meinem"],c:0,why:"مذكر فاعل → mein.",lvl:"A1",pos:"before-noun",typ:"poss",ctx:"family",start:"Das",w:"Bruder",structureType:"np_internal",subjectType:"noun-phrase",grammarTarget:"possessives",sentenceStarter:"Das",answerType:"poss",blankPosition:"before-noun"},
{id:"f11",s:"Wir kaufen ___ neuen Computer.",o:["einen","ein","eine","einem"],c:0,why:"مذكر مفعول → einen.",lvl:"A1",pos:"before-noun",typ:"article",ctx:"shopping",start:"Wir",structureType:"np_internal",subjectType:"pronoun",grammarTarget:"akkusativ",sentenceStarter:"Wir",answerType:"article",blankPosition:"before-noun"},
{id:"f12",s:"Maria ist nett. Ich mag ___.",o:["sie","ihr","du","es"],c:0,why:"مفعول sie ثابت.",lvl:"A1",pos:"end",typ:"pronoun",ctx:"friends",start:"Maria",structureType:"predicate_close",subjectType:"noun-phrase",grammarTarget:"pronouns",sentenceStarter:"Maria",answerType:"pronoun",blankPosition:"end"},
{id:"f13",s:"___ wohnst du?",o:["Wo","Wer","Wie","Wann"],c:0,why:"السؤال عن المكان = Wo.",lvl:"A1",pos:"start",typ:"question",ctx:"daily",start:"Wo",structureType:"fronted_opener",subjectType:"wh-word",grammarTarget:"w-fragen",sentenceStarter:"Wo",answerType:"question",blankPosition:"start"},
{id:"f14",s:"Ich habe ___ Auto.",o:["kein","keine","nicht","ein"],c:0,why:"Auto محايد → kein.",lvl:"A1",pos:"after-verb",typ:"negation",ctx:"daily",start:"Ich",w:"Auto",structureType:"verb_frame",subjectType:"pronoun",grammarTarget:"kein/nicht",sentenceStarter:"Ich",answerType:"negation",blankPosition:"after-verb"},
{id:"f15",s:"Das Auto ist sehr ___.",o:["schnell","langsam","schnelles","schnelle"],c:0,why:"الصفة بعد ist بدون نهاية.",lvl:"A1",pos:"end",typ:"adjective",ctx:"general",start:"Das",structureType:"predicate_close",subjectType:"noun-phrase",grammarTarget:"adjectives",sentenceStarter:"Das",answerType:"adjective",blankPosition:"end"},
{id:"f16",s:"Ich stehe ___ auf.",o:["früh","früher","frühe","frühen"],c:0,why:"الظرف بدون نهاية.",lvl:"A1",pos:"mid",typ:"adverb",ctx:"daily",start:"Ich",structureType:"midfield",subjectType:"pronoun",grammarTarget:"adverbs",sentenceStarter:"Ich",answerType:"adverb",blankPosition:"mid"},
{id:"f17",s:"Wir fahren ___ Berlin.",o:["nach","in","aus","zu"],c:0,why:"الاتجاه لمدينة = nach.",lvl:"A1",pos:"after-verb",typ:"prep",ctx:"travel",start:"Wir",structureType:"verb_frame",subjectType:"pronoun",grammarTarget:"prepositions",sentenceStarter:"Wir",answerType:"prep",blankPosition:"after-verb"},
{id:"f18",s:"Zum Telefonieren kaufe ich ein neues ___.",o:["Handy","Haus","Brot","Auto"],c:0,why:"السياق (للاتصال) يحدد الكلمة.",lvl:"A1",pos:"before-noun",typ:"vocab",ctx:"shopping",start:"Zum",w:"Handy",structureType:"np_internal",subjectType:"noun-phrase",grammarTarget:"vocabulary",sentenceStarter:"Zum",answerType:"vocab",blankPosition:"before-noun"},
{id:"f19",s:"Heute ___ ich Deutsch.",o:["lerne","lernst","lernt","lernen"],c:0,why:"الفعل ثانيًا ثم الفاعل.",lvl:"A1",pos:"after-time",typ:"verb",ctx:"study",start:"Heute",w:"lernen",structureType:"time_opener",subjectType:"adverbial",grammarTarget:"conjugation",sentenceStarter:"Heute",answerType:"verb",blankPosition:"after-time"},
{id:"f20",s:"___ Bruder wohnt in Berlin.",o:["Mein","Meine","Meinen","Ich"],c:0,why:"مذكر فاعل → Mein.",lvl:"A1",pos:"start",typ:"poss",ctx:"family",start:"Mein",w:"Bruder",structureType:"fronted_opener",subjectType:"noun-phrase",grammarTarget:"possessives",sentenceStarter:"Mein",answerType:"poss",blankPosition:"start"},
{id:"f21",s:"Ich sehe ___ alten Mann.",o:["den","der","dem","die"],c:0,why:"مذكر مفعول → den.",lvl:"A1",pos:"before-noun",typ:"article",ctx:"daily",start:"Ich",w:"Mann",structureType:"np_internal",subjectType:"pronoun",grammarTarget:"akkusativ",sentenceStarter:"Ich",answerType:"article",blankPosition:"before-noun"},
{id:"f22",s:"Morgen ___ meine Schwester nach Berlin.",o:["fährt","fahre","fährst","fahren"],c:0,why:"المفرد يأخذ t مع تغير الجذر.",lvl:"A1",pos:"after-time",typ:"verb",ctx:"family",start:"Morgen",structureType:"time_opener",subjectType:"noun-phrase",grammarTarget:"conjugation",sentenceStarter:"Morgen",answerType:"verb",blankPosition:"after-time"},
{id:"f23",s:"Am Wochenende ___ ich meine Freunde.",o:["besuche","besuchst","besuchen","besucht"],c:0,why:"ich تأخذ e.",lvl:"A1",pos:"after-time",typ:"verb",ctx:"friends",start:"Am",structureType:"time_opener",subjectType:"adverbial",grammarTarget:"conjugation",sentenceStarter:"Am",answerType:"verb",blankPosition:"after-time"},
{id:"f24",s:"___ gehe ich zur Universität.",o:["Heute","Ich","Gehe","Universität"],c:0,why:"الظرف أولًا ثم الفعل.",lvl:"A1",pos:"start",typ:"adverb",ctx:"study",start:"Heute",structureType:"fronted_opener",subjectType:"adverbial",grammarTarget:"adverbs",sentenceStarter:"Heute",answerType:"adverb",blankPosition:"start"},
{id:"f25",s:"Ich ___ jeden Morgen Kaffee.",o:["trinke","trinkst","trinkt","trinken"],c:0,why:"ich تأخذ e.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"food",start:"Ich",w:"trinken",structureType:"svo_core",subjectType:"pronoun",grammarTarget:"conjugation",sentenceStarter:"Ich",answerType:"verb",blankPosition:"after-subj"},
{id:"f26",s:"Ich warte ___ den Bus.",o:["auf","an","bei","zu"],c:0,why:"warten auf.",lvl:"A1",pos:"mid",typ:"prep",ctx:"travel",start:"Ich",structureType:"midfield",subjectType:"pronoun",grammarTarget:"prepositions",sentenceStarter:"Ich",answerType:"prep",blankPosition:"mid"},
{id:"f27",s:"Der Kaffee ___ heiß.",o:["ist","sind","seid","bist"],c:0,why:"المفرد يأخذ ist.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"food",start:"Der",w:"Kaffee",structureType:"svo_core",subjectType:"noun-phrase",grammarTarget:"conjugation",sentenceStarter:"Der",answerType:"verb",blankPosition:"after-subj"},
{id:"f28",s:"___ bitte die Tür!",o:["Mach","Machst","Machen","Macht"],c:0,why:"أمر du = الجذر.",lvl:"A1",pos:"start",typ:"imperative",ctx:"home",start:"Mach",structureType:"fronted_opener",subjectType:"verb-first",grammarTarget:"imperativ",sentenceStarter:"Mach",answerType:"imperative",blankPosition:"start"},
{id:"f29",s:"Ich ___ heute arbeiten.",o:["muss","musst","müssen","müsst"],c:0,why:"ich تأخذ muss.",lvl:"A1",pos:"after-subj",typ:"modal",ctx:"work",start:"Ich",w:"arbeiten",structureType:"svo_core",subjectType:"pronoun",grammarTarget:"modalverben",sentenceStarter:"Ich",answerType:"modal",blankPosition:"after-subj"},
{id:"f30",s:"Ist das ___ Schwester?",o:["meine","mein","meinen","meiner"],c:0,why:"مؤنثة → meine.",lvl:"A1",pos:"mid",typ:"poss",ctx:"family",start:"Das",structureType:"verb-first",subjectType:"noun-phrase",grammarTarget:"possessives",sentenceStarter:"Das",answerType:"poss",blankPosition:"mid"},
{id:"f31",s:"Wo ___ du gestern?",o:["warst","bist","war","wart"],c:0,why:"gestern ماضٍ: warst.",lvl:"A1",pos:"after-question",typ:"verb",ctx:"daily",start:"Wo",structureType:"wh_frame",subjectType:"wh-word",grammarTarget:"conjugation",sentenceStarter:"Wo",answerType:"verb",blankPosition:"after-question"},
{id:"f32",s:"Er trinkt ___ Kaffee.",o:["einen","ein","eine","einem"],c:0,why:"مذكر مفعول → einen.",lvl:"A1",pos:"before-noun",typ:"article",ctx:"food",start:"Er",w:"Kaffee",structureType:"np_internal",subjectType:"pronoun",grammarTarget:"akkusativ",sentenceStarter:"Er",answerType:"article",blankPosition:"before-noun"},
{id:"f33",s:"Die Kinder ___ laut.",o:["sind","seid","ist","bin"],c:0,why:"الجمع يأخذ sind.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"home",start:"Die",structureType:"svo_core",subjectType:"noun-phrase",grammarTarget:"conjugation",sentenceStarter:"Die",answerType:"verb",blankPosition:"after-subj"},
{id:"f34",s:"___ kommt aus Ägypten?",o:["Wer","Was","Wo","Wie"],c:0,why:"السؤال عن العاقل = Wer.",lvl:"A1",pos:"start",typ:"question",ctx:"daily",start:"Wer",structureType:"fronted_opener",subjectType:"wh-word",grammarTarget:"w-fragen",sentenceStarter:"Wer",answerType:"question",blankPosition:"start"},
{id:"f35",s:"Sie ___ jeden Tag.",o:["arbeitet","arbeiten","arbeitest","arbeite"],c:0,why:"Sie الرسمية تأخذ t.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"work",start:"Sie",w:"arbeiten",structureType:"svo_core",subjectType:"pronoun",grammarTarget:"conjugation",sentenceStarter:"Sie",answerType:"verb",blankPosition:"after-subj"},
{id:"f36",s:"Habt ihr ___ Zeit?",o:["keine","kein","nicht","keiner"],c:0,why:"Zeit مؤنثة → keine.",lvl:"A1",pos:"start",typ:"negation",ctx:"daily",start:"Habt",structureType:"fronted_opener",subjectType:"verb-first",grammarTarget:"kein/nicht",sentenceStarter:"Habt",answerType:"negation",blankPosition:"start"},
{id:"f37",s:"Er ___ einen Hund.",o:["hat","habe","hast","haben"],c:0,why:"er تأخذ hat.",lvl:"A1",pos:"after-subj",typ:"verb",ctx:"home",start:"Er",w:"Hund",structureType:"svo_core",subjectType:"pronoun",grammarTarget:"conjugation",sentenceStarter:"Er",answerType:"verb",blankPosition:"after-subj"},
{id:"f38",s:"Gestern ___ ich Fußball gespielt.",o:["habe","hast","hat","haben"],c:0,why:"الماضي مع haben.",lvl:"A2",pos:"after-time",typ:"aux",ctx:"sport",start:"Gestern",w:"Fußball",structureType:"time_opener",subjectType:"noun-phrase",grammarTarget:"perfect/future",sentenceStarter:"Gestern",answerType:"aux",blankPosition:"after-time"},
{id:"f39",s:"Morgen ___ ich nach Kairo fahren.",o:["werde","wirst","wird","werden"],c:0,why:"المستقبل مع werden.",lvl:"A2",pos:"after-time",typ:"aux",ctx:"travel",start:"Morgen",structureType:"time_opener",subjectType:"adverbial",grammarTarget:"perfect/future",sentenceStarter:"Morgen",answerType:"aux",blankPosition:"after-time"},
{id:"f40",s:"Ich habe gestern einen Film ___.",o:["gesehen","sehen","sieht","gesehene"],c:0,why:"التصريف الثالث آخر الجملة.",lvl:"A2",pos:"end",typ:"participle",ctx:"home",start:"Ich",w:"Film",structureType:"predicate_close",subjectType:"pronoun",grammarTarget:"partizip",sentenceStarter:"Ich",answerType:"participle",blankPosition:"end"},
{id:"f41",s:"Wir sind nach Berlin ___.",o:["gefahren","fahren","fährt","fahrst"],c:0,why:"fahren تأخذ sein.",lvl:"A2",pos:"end",typ:"participle",ctx:"travel",start:"Wir",structureType:"predicate_close",subjectType:"pronoun",grammarTarget:"partizip",sentenceStarter:"Wir",answerType:"participle",blankPosition:"end"},
{id:"f42",s:"Hast du die Hausaufgaben ___?",o:["gemacht","machen","macht","machst"],c:0,why:"التصريف الثالث.",lvl:"A2",pos:"end",typ:"participle",ctx:"school",start:"Hast",structureType:"predicate_close",subjectType:"verb-first",grammarTarget:"partizip",sentenceStarter:"Hast",answerType:"participle",blankPosition:"end"},
{id:"f43",s:"Ich muss heute früh ___.",o:["aufstehen","aufstehe","stehe auf","aufsteht"],c:0,why:"المنفصل آخر الجملة بالمصدر.",lvl:"A2",pos:"end",typ:"separable",ctx:"daily",start:"Ich",w:"aufstehen",structureType:"predicate_close",subjectType:"pronoun",grammarTarget:"trennbare",sentenceStarter:"Ich",answerType:"separable",blankPosition:"end"},
{id:"f44",s:"Ruf mich bitte ___!",o:["an","auf","aus","zu"],c:0,why:"anrufen = يتصل.",lvl:"A2",pos:"end",typ:"separable",ctx:"daily",start:"Ruf",structureType:"predicate_close",subjectType:"verb-first",grammarTarget:"trennbare",sentenceStarter:"Ruf",answerType:"separable",blankPosition:"end"},
{id:"f45",s:"Ich helfe ___ Bruder.",o:["meinem","meinen","mein","meine"],c:0,why:"helfen + Dativ.",lvl:"A2",pos:"before-noun",typ:"dativ",ctx:"family",start:"Ich",w:"Bruder",structureType:"np_internal",subjectType:"pronoun",grammarTarget:"dativ",sentenceStarter:"Ich",answerType:"dativ",blankPosition:"before-noun"},
{id:"f46",s:"Das Geschenk ist ___ dich.",o:["für","von","mit","zu"],c:0,why:"für + Akkusativ.",lvl:"A2",pos:"mid",typ:"prep",ctx:"friends",start:"Das",structureType:"midfield",subjectType:"noun-phrase",grammarTarget:"prepositions",sentenceStarter:"Das",answerType:"prep",blankPosition:"mid"},
{id:"f47",s:"___ regnet es heute.",o:["Es","Er","Sie","Das"],c:0,why:"الطقس = es.",lvl:"A2",pos:"start",typ:"pronoun",ctx:"weather",start:"Es",structureType:"fronted_opener",subjectType:"noun-phrase",grammarTarget:"pronouns",sentenceStarter:"Es",answerType:"pronoun",blankPosition:"start"},
{id:"f48",s:"Ich freue ___ auf den Urlaub.",o:["mich","dich","mir","michs"],c:0,why:"sich freuen auf + Akk.",lvl:"A2",pos:"mid",typ:"reflexive",ctx:"travel",start:"Ich",structureType:"midfield",subjectType:"pronoun",grammarTarget:"reflexivverben",sentenceStarter:"Ich",answerType:"reflexive",blankPosition:"mid"},
{id:"f49",s:"___ ihr schon gegessen?",o:["Habt","Haben","Hat","Hast"],c:0,why:"ihr تأخذ habt.",lvl:"A2",pos:"start",typ:"aux",ctx:"food",start:"Habt",structureType:"fronted_opener",subjectType:"noun-phrase",grammarTarget:"perfect/future",sentenceStarter:"Habt",answerType:"aux",blankPosition:"start"},
{id:"f50",s:"Die Tasche ___ meiner Schwester.",o:["gehört","gehören","gehöre","gehörst"],c:0,why:"المفرد يأخذ t.",lvl:"A2",pos:"after-subj",typ:"verb",ctx:"family",start:"Die",w:"Tasche",structureType:"svo_core",subjectType:"noun-phrase",grammarTarget:"conjugation",sentenceStarter:"Die",answerType:"verb",blankPosition:"after-subj"},
{id:"f51",s:"Wir treffen ___ am Bahnhof.",o:["uns","euch","sich","unsere"],c:0,why:"treffen + uns للجمع.",lvl:"A2",pos:"mid",typ:"reflexive",ctx:"travel",start:"Wir",structureType:"midfield",subjectType:"pronoun",grammarTarget:"reflexivverben",sentenceStarter:"Wir",answerType:"reflexive",blankPosition:"mid"},
{id:"f52",s:"Kannst du mir ___?",o:["helfen","helfe","hilfst","hilft"],c:0,why:"بعد المساعد مصدر.",lvl:"A2",pos:"end",typ:"verb",ctx:"friends",start:"Kannst",structureType:"predicate_close",subjectType:"verb-first",grammarTarget:"conjugation",sentenceStarter:"Kannst",answerType:"verb",blankPosition:"end"},
{id:"f53",s:"Er interessiert ___ für Autos.",o:["sich","dich","mich","sie"],c:0,why:"sich interessieren für.",lvl:"A2",pos:"mid",typ:"reflexive",ctx:"general",start:"Er",structureType:"midfield",subjectType:"pronoun",grammarTarget:"reflexivverben",sentenceStarter:"Er",answerType:"reflexive",blankPosition:"mid"},
{id:"f54",s:"Der Zug fährt ___ 10 Uhr ab.",o:["um","am","im","von"],c:0,why:"um للساعة.",lvl:"A2",pos:"mid",typ:"prep",ctx:"travel",start:"Der",structureType:"midfield",subjectType:"noun-phrase",grammarTarget:"prepositions",sentenceStarter:"Der",answerType:"prep",blankPosition:"mid"},
{id:"f55",s:"Unsere Eltern ___ in Alexandria.",o:["wohnen","wohnt","wohne","wohnst"],c:0,why:"الجمع يأخذ المصدر.",lvl:"A2",pos:"after-subj",typ:"verb",ctx:"family",start:"Unsere",w:"wohnen",structureType:"svo_core",subjectType:"noun-phrase",grammarTarget:"conjugation",sentenceStarter:"Unsere",answerType:"verb",blankPosition:"after-subj"},
{id:"f56",s:"Ich bleibe zu Hause, ___ ich krank bin.",o:["weil","denn","aber","und"],c:0,why:"weil + فعل آخر الجملة.",lvl:"B1",pos:"mid",typ:"conjunction",ctx:"home",start:"Ich",structureType:"midfield",subjectType:"pronoun",grammarTarget:"nebensatz",sentenceStarter:"Ich",answerType:"conjunction",blankPosition:"mid"},
{id:"f57",s:"___ ich müde bin, lerne ich weiter.",o:["Obwohl","Aber","Weil","Denn"],c:0,why:"obwohl = مع أن.",lvl:"B1",pos:"start",typ:"conjunction",ctx:"study",start:"Obwohl",structureType:"fronted_opener",subjectType:"adverbial",grammarTarget:"nebensatz",sentenceStarter:"Obwohl",answerType:"conjunction",blankPosition:"start"},
{id:"f58",s:"Ich denke, ___ du recht hast.",o:["dass","was","wer","wie"],c:0,why:"dass للاعتقاد.",lvl:"B1",pos:"mid",typ:"conjunction",ctx:"general",start:"Ich",structureType:"midfield",subjectType:"pronoun",grammarTarget:"nebensatz",sentenceStarter:"Ich",answerType:"conjunction",blankPosition:"mid"},
{id:"f59",s:"Wenn es ___, bleiben wir zu Hause.",o:["regnet","regnen","regne","regnst"],c:0,why:"es regnet.",lvl:"B1",pos:"mid",typ:"verb",ctx:"weather",start:"Wenn",structureType:"midfield",subjectType:"adverbial",grammarTarget:"conjugation",sentenceStarter:"Wenn",answerType:"verb",blankPosition:"mid"},
{id:"f60",s:"Das Buch, ___ ich lese, ist spannend.",o:["das","was","der","die"],c:0,why:"ضمير الوصل = das.",lvl:"B1",pos:"mid",typ:"relative",ctx:"general",start:"Das",w:"Buch",structureType:"midfield",subjectType:"noun-phrase",grammarTarget:"relativsatz",sentenceStarter:"Das",answerType:"relative",blankPosition:"mid"},
{id:"f61",s:"Er fragt, ___ der Zug kommt.",o:["wann","was","wer","wo"],c:0,why:"السؤال عن الوقت = wann.",lvl:"B1",pos:"mid",typ:"question",ctx:"travel",start:"Er",structureType:"midfield",subjectType:"pronoun",grammarTarget:"w-fragen",sentenceStarter:"Er",answerType:"question",blankPosition:"mid"},
{id:"f62",s:"Trotz ___ Wetters bleiben wir zu Hause.",o:["des","dem","der","den"],c:0,why:"trotz + Genitiv.",lvl:"B1",pos:"mid",typ:"genitive",ctx:"weather",start:"Trotz",structureType:"midfield",subjectType:"adverbial",grammarTarget:"genitiv",sentenceStarter:"Trotz",answerType:"genitive",blankPosition:"mid"},
{id:"f63",s:"Je mehr ich lerne, ___ besser spreche ich.",o:["desto","als","wie","wenn"],c:0,why:"je...desto للمقارنة.",lvl:"B1",pos:"mid",typ:"conjunction",ctx:"study",start:"Je",structureType:"midfield",subjectType:"adverbial",grammarTarget:"nebensatz",sentenceStarter:"Je",answerType:"conjunction",blankPosition:"mid"},
{id:"f64",s:"Ich weiß nicht, ___ ich machen soll.",o:["was","wer","wo","dass"],c:0,why:"was + soll.",lvl:"B1",pos:"mid",typ:"question",ctx:"general",start:"Ich",structureType:"midfield",subjectType:"pronoun",grammarTarget:"w-fragen",sentenceStarter:"Ich",answerType:"question",blankPosition:"mid"},
{id:"f65",s:"Er arbeitet, ___ Geld zu verdienen.",o:["um","zu","für","damit"],c:0,why:"um...zu للغرض.",lvl:"B1",pos:"mid",typ:"umzu",ctx:"work",start:"Er",structureType:"midfield",subjectType:"pronoun",grammarTarget:"um-zu",sentenceStarter:"Er",answerType:"umzu",blankPosition:"mid"},
{id:"f66",s:"Jeden Abend ___ ich Deutsch.",o:["lerne","lernst","lernt","lernen"],c:0,why:"الفعل ثانيًا ثم الفاعل.",lvl:"A2",pos:"after-time",typ:"verb",ctx:"study",start:"Jeden",w:"lernen",structureType:"time_opener",subjectType:"adverbial",grammarTarget:"conjugation",sentenceStarter:"Jeden",answerType:"verb",blankPosition:"after-time"},
{id:"f67",s:"___ besucht meinen Bruder?",o:["Wer","Wen","Was","Wo"],c:0,why:"السؤال عن الفاعل = Wer.",lvl:"A2",pos:"start",typ:"question",ctx:"family",start:"Wer",structureType:"fronted_opener",subjectType:"wh-word",grammarTarget:"w-fragen",sentenceStarter:"Wer",answerType:"question",blankPosition:"start"}];
...
function runFill(box,lvl){
  ...
  function q(){
    ...
    box.innerHTML='<div class="muted">سؤال '+(i+1)+'/'+pool.length+' • <span class="tag">'+m.lvl+'</span></div><h3 class="fill-sent" style="direction:ltr">'+fillBlankHtml(m.s)+'</h3><div id="gQ"></div><div class="quiz-feedback hidden" id="gFb"></div><div class="row-flex"><button class="btn btn-primary hidden" id="gNextQ">التالي ⏭</button></div>';
    gameOpts($("gQ"),sh.opts.map((o,j)=>letters[j]+" ) "+o),j=>{
      const fb=$("gFb");fb.classList.remove("hidden");
      const blank=$("fillBlank");
      if(blank){blank.textContent=sh.opts[j];blank.classList.add(j===sh.correct?"filled-ok":"filled-no");}
      if(j===sh.correct){fb.className="quiz-feedback ok";fb.textContent="✅ Richtig! "+m.s.replace("___",sh.opts[sh.correct])+" — "+m.why;score++;S.totalCorrect++;}
      ...
      S.totalAnswered++;sessTick(j===sh.correct,w?w.id:undefined);save();
