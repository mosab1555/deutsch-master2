...
function ensureStudy(){
  ...
  if(!S.flashDir)S.flashDir="de-ar";
  if(!S.srs)S.srs={};
...
function initHeaderLang(){
  ...
  try{if(typeof updateFlashDirBtn==="function")updateFlashDirBtn();}catch(e){}
}
